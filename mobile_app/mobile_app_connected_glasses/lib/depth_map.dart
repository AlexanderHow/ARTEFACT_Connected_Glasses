      ...
      StreamBuilder<List<BluetoothService>>(
        ...
        builder: (c, snapshot) {
          return Scaffold(
            ...
            body: Center(child: (snapshot == null || snapshot.data.isEmpty || snapshot.data[0].characteristics.isEmpty) ?
                DepthMapGrid(null) : DepthMapGrid(snapshot.data[0].characteristics[0])), //get the only service which have one characteristic
          );
        }
      )
    );
